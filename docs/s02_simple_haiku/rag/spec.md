...
- если параметра question нет, то сервис возращает {'error': 'Missing question'}, 400
- если поиск по индексу завершается ошибкой, то сервис возращает {'error': 'Search failed'}, 500
- если происходит другая ошибка, то сервис возращает {'error': 'Internal server error'}, 500
