...
Если ввод содержит команду из списка `config.clear_commands`, то агент выводит "История сообщений очищена." в stdout, пишет "AgentClear" в лог (debug) и запрашивает ввод еще раз.
