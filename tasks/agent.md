...
- логирование
- что ответит агента, если в запросе на топ студентов нет основного предмета (напр., "топ студентов по философии")
- другие похожие ситуации, явно не прописанные в задании/тестах
