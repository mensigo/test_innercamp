"""Run place-oriented search_rag cases and print retrieved chunk previews."""
...
CASES_ML_PLACE: list[SearchRagCase] = [
    SearchRagCase(
        idx=1,
...
CASES_PROB_PLACE: list[SearchRagCase] = [
    SearchRagCase(
        idx=5,
...
CASES_OPT_PLACE: list[SearchRagCase] = [
    SearchRagCase(
        idx=9,
...
if __name__ == '__main__':
    ...
    print_cases(
        CASES_PROB_PLACE,
        'search_rag prob (place)',
        show_full_chunk=args.print,
    )
    print_cases(
        CASES_OPT_PLACE,
        'search_rag opt (place)',
        show_full_chunk=args.print,
    )
